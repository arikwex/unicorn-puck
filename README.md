...
A deliberately empty JS13k starter. It retains the reusable engine and packaging ideas from [Infernal Sigil](https://github.com/arikwex/infernal-sigil) without copying its game, assets, entities, maps, or rules. The initial scene is a black canvas with zero game objects.
...
- `src/tags.js` — shared numeric tags (only the camera tag exists initially)
